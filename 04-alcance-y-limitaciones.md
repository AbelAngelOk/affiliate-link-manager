...
- **Sin "olvidé mi contraseña"**: no hay endpoint de recuperación. Si alguien pierde su contraseña, hoy no tiene forma de recuperar el acceso a esa cuenta (ni siquiera vos como operador — no hay ningún rol con esa capacidad, ver siguiente punto).
